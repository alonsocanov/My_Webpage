...
class Migration_Experience extends CI_Migration {
	...
	public function up() {
		...
		$data['priority'] = 1;
		$data['start_date'] = '2020-05-01';
		$data['end_date'] = '';
		$data['location'] = 'Leon, Gto';
		$data['image'] = 'Ixaya_thumb.jpg';
		$data['image_url'] = '//127.0.0.1:8000/admin/experiences/picture/3';
		...
		$data['image'] = 'AFD_Technologies_thumb.jpg';
		$data['image_url'] = '//127.0.0.1:8000/admin/experiences/picture/4';
		...
		$data['end_date'] = '';
		$data['location'] = 'Paris, France';
		$data['image'] = 'Electronics_and_Electromagnetism_Laboratory_(L2E)_thumb.jpg';
		$data['image_url'] = '//127.0.0.1:8000/admin/experiences/picture/5';
